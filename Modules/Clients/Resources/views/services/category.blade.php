...
<main class="main">
    <div class="container">
        ...
        <section class="banner-service">
            <img src="{{asset('assets/images/banners/banner-service.png')}}" style="width:100%;" alt="">
            ...
            <div class="box-search-filter mobile">
                <form action="">
                    <div class="box">
                        ...
                        <button class="btn btn-search"><img src="{{asset('assets/images/icons/icon_search_white.svg')}}" alt=""></button>
                    </div>
                </form>
            </div>
        </section>
        ...
        <section class="contact">
            <div class="row">
                <div class="col-lg-6">
                    <div class="box-image">
                        <img src="{{asset('assets/images/icons/Artboard 10bgr.svg')}}" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
