...
class AdvertisementsController extends Controller
{
    ...
    public function create()
    {
        try {
            ...
            return view('admins::advertisements.create', ['data' => $data]);
        } catch (\Exception $e) {
            abort('500');
        }
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('admins::advertisements.edit', ['data' => $data]);
        } catch (\Exception $e) {
    ...
    public function update(EditRequest $request, $id)
    {
        try {
            ...
            if ($this->advertisementService->update($_params, $id)) {
                ...
                return redirect(route('admin.advertisement.index', ['page' => (!empty($_GET['page']) ? $_GET['page'] : 1)]));
            } else {
                $errors = new MessageBag(['error' => __('admins::layer.notify.fail')]);
                return back()->withInput($_params)->withErrors($errors);
            }
