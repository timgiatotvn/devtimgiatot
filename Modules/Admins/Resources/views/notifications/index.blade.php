                                ...
                                @if (count($data['list']) > 0)
                                    @foreach($data['list'] as $k=>$row)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="icon-form" title="edit" href="{{ route('notification.edit', $row->id) }}">
                                                    <i class="icon-note"></i>
                                                </a>
                                                <a class="icon-form" href="javascript:confirmDelete('{{ route('admin.notification.destroy', ['id' => $row->id]) }}','@lang('admins::layer.notify.confirm.delete')')">
