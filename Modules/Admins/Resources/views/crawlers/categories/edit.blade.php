                        ...
                        <div class="card-body">
                            ...
                            <div style="background: #0a6aa1; color: #fff; padding: 20px 20px 1px 20px; margin-bottom: 15px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $data['detail']->class_detail_price_sale }}" name="class_detail_price_sale" class="form-control" placeholder=""/>
                                </div>
                                <div class="form-group">
                                    <label>Class giá flash sale root</label>
                                    <input type="text" value="{{ $data['detail']->class_detail_price_sale_root }}" name="class_detail_price_sale_root" class="form-control" placeholder=""/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-2">
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="type_crawler"
                                                       value="ajax" {{ ($data['detail']->type_crawler == "ajax") ? 'checked' : '' }}>
                                                Ajax
                                            </label>
                                        </div>
                                    </div>
