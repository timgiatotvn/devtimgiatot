                ...
                <div class="d-flex flex-column flex-md-row align-items-center">
                    ...
                    <div class="wrapper ml-md-auto d-flex flex-column flex-md-row kanban-toolbar ml-n2 ml-md-0 mt-4 mt-md-0">
                        <div class="d-flex mt-4 mt-md-0">
                            <a href="{{ route('admin.productCrawler.create') }}">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    @foreach($data['list'] as $k=>$row)
                                        <tr>
                                            ...
                                            <td><img src="{{ !empty($row->thumbnail_cr) ? asset($row->thumbnail_cr) : asset($row->thumbnail) }}" class="mw-100"></td>
                                            <td>
                                                ...
                                                <a class="icon-form" title="edit"
                                                   href="{{ route('admin.productCrawler.edit', ['id' => $row->id, 'page' => $data['list']->currentPage()]) }}">
                                                    <i class="icon-note"></i>
                                                </a>
                                                <a class="icon-form status active"
                                                   href="{{ route('admin.productCrawler.status', ['id' => $row->id, 'field' => 'status']) }}">
                                                    {!! (($row->status == 1) ? '<i class="icon-check"></i>' : '<i class="icon-close"></i>') !!}
                                                </a>
                                                <a class="icon-form"
                                                   href="javascript:confirmDelete('{{ route('admin.productCrawler.destroy', ['id' => $row->id]) }}','@lang('admins::layer.notify.confirm.delete')')">
                                            ...
                                            {{--                                        <td>--}}
                                            {{--                                            <a class="icon-form status active" href="{{ route('admin.productCrawler.status', ['id' => $row->id, 'field' => 'choose_1']) }}">--}}
                                            {{--                                                {!! (($row->choose_1 == 1) ? '<i class="icon-check"></i>' : '<i class="icon-close"></i>') !!}--}}
                                            {{--                                            </a>--}}
                                            {{--                                        </td>--}}
                                            {{--                                        <td>--}}
                                            {{--                                            <a class="icon-form status active" href="{{ route('admin.productCrawler.status', ['id' => $row->id, 'field' => 'choose_2']) }}">--}}
                                            {{--                                                {!! (($row->choose_2 == 1) ? '<i class="icon-check"></i>' : '<i class="icon-close"></i>') !!}--}}
                                            {{--                                            </a>--}}
                                            {{--                                        </td>--}}
                                            {{--                                        <td>--}}
                                            {{--                                            <a class="icon-form status active" href="{{ route('admin.productCrawler.status', ['id' => $row->id, 'field' => 'choose_3']) }}">--}}
                                            {{--                                                {!! (($row->choose_3 == 1) ? '<i class="icon-check"></i>' : '<i class="icon-close"></i>') !!}--}}
                                            {{--                                            </a>--}}
                                            {{--                                        </td>--}}
                                            {{--                                        <td>--}}
                                            {{--                                            <a class="icon-form status active" href="{{ route('admin.productCrawler.status', ['id' => $row->id, 'field' => 'choose_4']) }}">--}}
