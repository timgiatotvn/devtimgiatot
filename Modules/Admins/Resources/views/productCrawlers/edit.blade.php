                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <textarea name="keyword_suggest" rows="5" class="form-control">{{ $data['detail']->keyword_suggest }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Tiêu đề</label>
...
@endsection
@section('validate')
    {!! JsValidator::formRequest('Modules\Admins\Http\Requests\ProductCrawler\EditRequest','#form-edit'); !!}
@endsection
