...
@section('content')
    <div class="content-wrapper">
        <form method="post" action="{{route('admin.setting.permission.create')}}" class="forms-sample" id="form-create">
            @csrf()
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" placeholder="Viết tiếng anh" class="form-control" placeholder=""/>
                            </div>
                            <div class="form-group">
