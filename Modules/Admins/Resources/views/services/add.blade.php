...
@section('content')
    <div class="content-wrapper">
        <form method="POST" action="{{route('admin.service.store')}}" class="forms-sample">
            @csrf()
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <label>Tiêu đề</label>
                                <input value="{{old('title')}}" type="text" required name="title" class="form-control" placeholder=""/>
                            </div>
                            <div class="form-group">
                                <label>Slug</label>
                                <input type="text" value="{{old('slug')}}" required name="slug" class="form-control" placeholder=""/>
                            </div>
                            <div class="form-group">
			                ...
			                <div class="form-group">
                                <label>Địa chỉ</label>
                                <input type="text" value="{{old('address')}}" name="address" required class="form-control"/>
                            </div>
                            <div class="form-group">
                                <label>Dịch vụ (cách nhau bởi dấu ;)</label>
                                <input value="{{old('service')}}" type="text" name="service" required class="form-control"/>
                            </div>
                            <div class="form-group">
                                <label>Giá</label>
                            ...
                            <div class="form-group">
                                <label>Liên hệ</label>
                                <input type="text" value="{{old('hotline')}}" name="hotline" required class="form-control"/>
                            </div>
                            <div class="form-group">
                                <label>Zalo</label>
                                <input type="text" value="{{old('zalo')}}" name="zalo" required class="form-control"/>
                            </div>
                            <div class="form-group">
                                <label>Đánh giá</label>
                                <input type="number" value="{{old('rate')}}" name="rate" required class="form-control"/>
                            </div>
                            <div class="form-group">
                                <label>Tổng người đánh giá</label>
                                <input type="number" value="{{old('total_rate')}}" name="total_rate" required class="form-control"/>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail" required value="{{old('thumbnail')}}" class="form-control" type="text" name="thumbnail"
                                                   readonly>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input id="logo" required value="{{old('logo')}}" class="form-control" type="text" name="logo"
                                                   readonly>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input id="banner" required value="{{old('banner')}}" class="form-control" type="text" name="banner"
                                                   readonly>
                                        </div>
