...
class SlideshowsController extends Controller
{
    ...
    public function __construct(AdvertisementService $advertisementService)
    {
        ...
        $this->type = $this->advertisementService::TYPE[2];
    }
    ...
    public function index()
    {
        try {
            ...
            return view('admins::slideshows.index', ['data' => $data]);
    ...
    public function create()
    {
        try {
            ...
            return view('admins::slideshows.create', ['data' => $data]);
        } catch (\Exception $e) {
            abort('500');
        }
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('admins::slideshows.edit', ['data' => $data]);
        } catch (\Exception $e) {
