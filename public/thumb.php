...

{
...

    {
        ...
        if ($count) {
            ...
            $this->query['src'] = dirname($_SERVER['SCRIPT_NAME']) . '/storage/' . $img;

            if (!is_file('storage/' . $img) || !file_exists('storage/' . $img)) {
