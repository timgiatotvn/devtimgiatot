            ...
            yAxes: [
                {
                    ticks: {
                        ...
                        beginAtZero: true,
                        stepSize: 2 // if i use this it always set it '1', which look very awkward if it have high value  e.g. '100'.
                    }
                }
            ]
        },
            ...
            yAxes: [
                {
                    ticks: {
                        min: 0, // it is for ignoring negative step.
                        beginAtZero: true,
                        stepSize: 4 // if i use this it always set it '1', which look very awkward if it have high value  e.g. '100'.
                    }
                }
            ]
        }
